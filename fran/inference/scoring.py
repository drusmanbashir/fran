...
def compute_dice_fran(pred, mask, n_classes):
    ...
    pred_onehot, label_onehot = [
        one_hot(x, classes=n_classes, axis=0).unsqueeze(0) for x in [pred_pt, label_pt]
    ]
...
if __name__ == "__main__":
    ...
    # %%
    pred_onehot, label_onehot = [
        one_hot(x, classes=n_classes, axis=1) for x in [pred_pt, label_pt]
    ]
    D2 = DiceLoss(
