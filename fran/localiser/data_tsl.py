...
from fran.transforms.misc_transforms import BoundingBoxYOLOd, BoundingBoxesYOLOd
...
class DetectDataModuleTSL(L.LightningDataModule):
    ...
    def create_transforms(self, probs=0.3, probs_intensity=0.3):
        ...
        # keys_tr="L,MkB,  Et, Et2, N,IntensityTfms, Flip1, Flip2, Zoom, Resize, ExtractBbox, CB,YoloBboxes, Rp ",  # NO ROTATION, No Del
    ...
    def setup(self, stage: str):
        ...
        self.set_transforms(
            # keys_tr="L,MkB,  Et, Et2, N,I, Flip1, Flip2, Rotate,Z, Resize, ExtractBbox, CB,YoloBboxes, DelI,Rp ",
            keys_tr="L,MkB,  Et, Et2, N,IntensityTfms, Flip1, Flip2, Zoom, Resize, ExtractBbox, CB,YoloBboxes, Rp ",  # NO ROTATION, No Del
            keys_val="L,MkB,Et, Et2, N, Resize,ExtractBbox, CB,YoloBboxes,DelI, Rp",
        )
        if stage == "fit":
...
if __name__ == "__main__":
    ...
    dm = DetectDataModule(data_dir="/s/xnat_shadow/totalseg2d/")
    dm.prepare_data()
    dm.setup(stage="fit")
...
# %%
    ...
    dici = dm.transforms_dict["MkB"](dici)
    dici = dm.transforms_dict["N"](dici)
    dici = dm.transforms_dict["Et"](dici)
    dici = dm.transforms_dict["Et2"](dici)

    dici2 = dm.transforms_dict["ExtractBbox"](dici)
    dici3 = dm.transforms_dict["CB"](dici2)
    dici4 = dm.transforms_dict["YoloBboxes"](dici3)
...
# %%
    ...
    Y= BoundingBoxesYOLOd(
        [box_key], 2, key_template_tensor=label_key, output_keys=["bbox_yolo"]
    )
    dici4 = Y(dici3)

    dici4['bbox_yolo'].shape
...
# %%
    ...
    bb2 = bb[n].tolist()
# %%
    lmv = torch.permute(lm[n], (1, 0))
    draw_image_lm_bbox(imv, lmv, *bb2)
...
# %%
    ...
    # tfms_val = Compose([L, MkB, ExtractBbox, CB, Et, Et2, ClipoBbox, YoloBboxes])
# %%
# %%
