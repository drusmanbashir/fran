...
class _Preprocessor2DWorkerBase:
...
class Preprocessor2DWorker(_Preprocessor2DWorkerBase):
    pass


class Preprocessor2DWorkerLocal(_Preprocessor2DWorkerBase):
    pass
...
class Preprocessor2D:
    def __init__(self, data_folder, output_folder):
        ...
        self.actor_cls = Preprocessor2DWorker
        self.local_worker_cls = Preprocessor2DWorkerLocal
